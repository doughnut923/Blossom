...
2. using a soldering iron or hot glue to insert 8 [M2.5 inserts](https://mecha4makers.co.nz/product/m2-5-x-3mm-threaded-insert-brass/) to the corrisponding positions.
3. Using the dxf files in the `plate_dxfs`, make the palte and the gasket with the material of you r choice.
...
7. Screw two halfs of the case together using a [socket headed M2.5 screw](https://www.amazon.com/50-M2-5-0-45-5mm-Stainless-MonsterBolts/dp/B078KZZKPC).
